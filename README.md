...
.\build\Release\opengil.exe decoration add --input I:\Wanderland\genshin-ts\backups\1073741843.gil --output decorated.gil --prefab-id 1077936385 --asset-id 20001220 --name Deco --pos-x 0 --pos-y 1.9 --pos-z 0 --scale-x 0.3 --scale-y 0.04 --scale-z 0.3
.\build\Release\opengil.exe attachment add --input I:\Wanderland\genshin-ts\backups\1073741843.gil --output attached-point.gil --prefab-id 1077936385 --name Hand --display-name "Hand Point" --pos-x 0.48 --pos-y 1.52 --rot-x -37.9 --rot-y 81.9
